...
class CountingRationalWithoutText4(Scene):
    ...
    def construct(self):
        ...
        self.remove( all_pts_and_labels)  #eq_curve_of_rank_0,
        ...
        taaable_up_to_10, points_up_to_10, indices = list_of_points(10)
        ...
        taaable_up_to_100, points_up_to_100, indices = list_of_points(100)
...
if __name__ == "__main__":
    ...
    scene = CountingRationalWithoutText4()
    scene.render()
